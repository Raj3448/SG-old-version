            ...
            children: [
              Scaffold(
                ...
                body: Padding(
                  ...
                  child: servicePaymentStatusModel == null ? FutureBuilder(
                  ...
                  ) : buildDetail(context, getPaymentStatus(
                          paymentStatus: servicePaymentStatusModel!.paymentStatus,
                          status: servicePaymentStatusModel!.status)),
                ),
              ),
                              ...
                              Row(
                                children: [
                                  Icon(
                                    ...
                                    color: _getStatusIconColor(servicePaymentStatusModel!.paymentStatus, servicePaymentStatusModel!.status),
                                  ),
                                  const SizedBox(
                                    width: Dimension.d2,
                                  ),
                        ...
                        ListView.separated(
                            ...
                            itemBuilder: (context, index) =>
                                !servicePaymentStatusModel!.metadata[index].private
                                    ? ExpandedAnalogComponent(
                                        label: servicePaymentStatusModel!
                                            .metadata[index].key,
                                        value: servicePaymentStatusModel
