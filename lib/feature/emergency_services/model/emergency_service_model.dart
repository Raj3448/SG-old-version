...
EmergencyServiceModel emergencyServiceModelFromJson(String str) => EmergencyServiceModel.fromJson(json.decode(str) as Map<String,dynamic>);

String emergencyServiceModelToJson(EmergencyServiceModel data) => json.encode(data.toJson()as Map<String,dynamic>);

@freezed
class EmergencyServiceModel with _$EmergencyServiceModel {
    const factory EmergencyServiceModel({
        @JsonKey(name: "defination")
        required String defination,
        @JsonKey(name: "support")
        required Support support,
        @JsonKey(name: "plansDescription")
        required String plansDescription,
        @JsonKey(name: "plans")
        required List<Plan> plans,
    }) = _EmergencyServiceModel;

    factory EmergencyServiceModel.fromJson(Map<String, dynamic> json) => _$EmergencyServiceModelFromJson(json);
}
