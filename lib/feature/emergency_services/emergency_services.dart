...
class EmergencyServices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final emergencyServiceStore = GetIt.instance.get<EmergencyServiceStore>();
    return Scaffold(
      appBar: AppBar(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              emergencyServiceStore.emergencyServiceModel.defination,
              style: AppTextStyle.bodyMediumMedium.copyWith(
                color: AppColors.grayscale700,
                fontSize: 14,
                height: 1.46,
            ...
            TitleDescriptComponent(
              ...
              description:
                  emergencyServiceStore.emergencyServiceModel.support.hospital,
            ),
            const SizedBox(
              height: Dimension.d2,
            ),
            ...
            TitleDescriptComponent(
              ...
              description:
                  emergencyServiceStore.emergencyServiceModel.support.genieCare,
            ),
            const SizedBox(
              height: Dimension.d5,
            ),
            ...
            Text(
              emergencyServiceStore.emergencyServiceModel.plansDescription,
              style: AppTextStyle.bodyMediumMedium.copyWith(
                color: AppColors.grayscale700,
                fontSize: 14,
                height: 1.46,
