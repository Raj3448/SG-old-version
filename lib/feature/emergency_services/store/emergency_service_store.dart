  ...
  EmergencyServiceModel emergencyServiceModel = const EmergencyServiceModel(
    ...
    plans: <Plan>[
      Plan(
        title: 'Basic',
        duration: 'Yearly',
        descrip: 'Including all tax',
        amount: 18000,
        discountamount: 14000, isSelected: false,
      ),
      Plan(
        title: 'Premium',
        duration: '6 Months',
        descrip: 'Including all tax',
        amount: 7689,
        discountamount: 3500, isSelected: false,
      ),
      Plan(
        title: 'Standard',
        duration: '1 Months',
        descrip: 'Including all tax',
        amount: 3500,
        discountamount: 2677, isSelected: false,
      ),
    ],
    plansDescription:
        'Silvergenie ensures your safety with emergency preparedness forms, ambulance services, and Genie Care support. Our SOS app and speed dial feature offer immediate assistance, making your well-being our priority.',
  );
}
