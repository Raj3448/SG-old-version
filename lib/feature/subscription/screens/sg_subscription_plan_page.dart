...
class sgSubscriptionPage extends StatefulWidget {
  const sgSubscriptionPage({super.key});

  @override
  State<sgSubscriptionPage> createState() => _sgSubscriptionPageState();
}

class _sgSubscriptionPageState extends State<sgSubscriptionPage> {
  @override
