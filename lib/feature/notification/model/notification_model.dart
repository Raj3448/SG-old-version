...
class AppNotifications with _$AppNotifications {
    const factory AppNotifications({
        required int id,
        @JsonKey(name: 'attributes') required NotificationMetaData notificationMetaData,
    }) = _AppNotifications;
    factory AppNotifications.fromJson(Map<String, dynamic> json) => _$AppNotificationsFromJson(json);
}
...
class AdditionalDatum with _$AdditionalDatum {
    ...
    factory AdditionalDatum.fromJson(Map<String, dynamic> json) => _$AdditionalDatumFromJson(json);
}