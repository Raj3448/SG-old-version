...
class ServiceDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final serviceData = store.selectedProduct!.product;
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            _HeaderPicTitle(
              ...
              title: serviceData.subscriptionContent!.mainHeading,
              desc: serviceData.subscriptionContent!.headingDescription,
            ),
            const SizedBox(height: Dimension.d4),
            _HomeCareOfferings(serviceData: serviceData),
          ],
        ),
      ),
    );
            ...
            children: [
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      '${Env.serverUrl}${serviceData.subscriptionContent!.productImage.data.attributes.url}',
                ),
              ),
              const SizedBox(height: Dimension.d4),
              Text(title, style: AppTextStyle.bodyXLMedium),
            ],
          ),
        ),
...
class _HomeCareOfferings extends StatelessWidget {
  const _HomeCareOfferings({required this.serviceData});
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('${serviceData.name} offerings', style: AppTextStyle.bodyXLMedium),
        const SizedBox(height: Dimension.d3),
        // _OfferTile(serviceData.serviceContent.)
      ],
    );
  }
}
