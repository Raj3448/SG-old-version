...
class UserProfile extends StatelessWidget {
    ...
    return Observer(
      builder: (context) {
        return Scaffold(
          ...
          body: store.isLoading ? const Center(child: CircularProgressIndicator()): SingleChildScrollView(
            child: Padding(
  ...
  // void _tempMethod(fp.Either<UserFailure, UserDetails> snapshot) {
  //   snapshot.fold(
  //     (failure) {
  //       failure.map(socketException: (value) {
  //         print(value);
