            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomButton(
                      ontap: () async {
                        UserDetailStore store = GetIt.I<UserDetailStore>();
  ...
  void _initializeControllers(fp.Either<Failure, Success> snapshot) {
    snapshot.fold(
      ...
      (success) {
        ...
        _fullNameController.text = success.userDetails.fullname;
    dateBirth = success.userDetails.dateBirth;

    _genderController.selectedOptions.add(_genderItems[0]);
    _mobileController.text = success.userDetails.mobileNum;
    _emailController.text = success.userDetails.emailId;
    _addressController.text = success.userDetails.address;
    ...
    _postalController.text = success.userDetails.postalCode.toString();
